...
function Footer() {
    return (
        <div className='flex gap-1 w-full h-screen bg-zinc-900 p-20 font-mono'>
            <div className='w-1/2 h-full flex flex-col justify-between '>
                <div className='heading'>
                    <h1 className='text-[8vw] uppercase -mb-10 tracking-tighter'>Eye-</h1>
                    <h1 className='text-[8vw] uppercase -mb-10 leading-none tracking-tighter'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
            <h1 className='text-[7vw] uppercase -mb-10 leading-none tracking-tighter'>
                Presentations
            </h1>
            <div className='dets font-["Neue_Montreal"] mt-32'>
                    <a className="block text-xl font-light underline hover:bg-zinc-500 hover:mt-3" href="https://www.facebook.com/people/OCHI-presentation-design/100067218942460/">Facebook</a>
                    <a className="block text-xl font-light underline hover:bg-zinc-500 hover:mt-3" href="https://www.instagram.com/ochi_design/">Instagram</a>
                    <a className="block text-xl font-light underline hover:bg-zinc-500 hover:mt-3" href="https://www.linkedin.com/company/ochi-design/">Linkedin</a>
                </div>
            </div>
        </div>
    )
